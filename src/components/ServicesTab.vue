...
<template>
    <div class="max-w-3xl mx-auto text-gray-800">
        <h2 class="text-[18px] md:text-[26px] tracking-[0.2em] uppercase my-12 text-center text-black">
            {{ t("manpower.services.title") }}
        </h2>

        <p class="text-[.65em] md:text-[.99em] font-light mb-8 text-pretty text-center px-[10px] md:px-0"
        ...
        <div class="md:w-180 md:ml-14 px-4 md:px-0 mx-auto">
            ...
            <div class="grid grid-cols-1">
                <div v-for="i in [1, 2, 3, 4, 5, 6, 7, 8]" :key="i" class="flex items-start space-x-2">
                    ...
                    <div class="text-[0.6em] md:text-[0.9em] leading-relaxed">
                        <span class="md:min-w-[120px] inline-block font-bold md:font-normal">
